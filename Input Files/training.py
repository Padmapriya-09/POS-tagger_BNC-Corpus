...
if os.path.exists('list_of_tags.txt'):
	os.remove('list_of_tags.txt')
if os.path.exists('list_of_words.txt'):
	os.remove('list_of_words.txt')
...
if os.path.exists('trained_file.txt'):
	os.remove('trained_file.txt')
